    ...
    <main className="min-h-screen bg-bpaper">
      ...
      <section className="relative">
        ...
        <div className="relative h-[50vh] md:h-[60vh] lg:h-[70vh]">
          ...
          <div className="site-container absolute inset-x-0 top-0 z-10 pt-28 md:pt-32">
            <p className="mb-3 text-sm font-bold uppercase text-bblue">Facility</p>
        ...
        <div className="site-container">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Short Description */}
              <div>
                <p className="text-bink/70 text-lg">
              ...
              <Card>
                <CardContent className="p-6 md:p-8">
                  <h2 className="text-xl font-bold text-bnavy mb-4">About This Facility</h2>
              ...
              <Card>
                <CardContent className="p-6 md:p-8">
                  <h2 className="text-xl font-bold text-bnavy mb-6">Features & Highlights</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {facility.features.map((feature, index) => (
                      <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-bpaper">
                        ...
                        <span className="text-bink/80">{feature.text}</span>
                      </div>
                    ))}
                  </div>
                </CardContent>
                ...
                <Card>
                  <CardContent className="p-6 md:p-8">
                    <div className="text-center mb-6">
                      <h3 className="text-xl font-bold text-bnavy mb-2">
                        Interested in this facility?
                      </h3>
                      <p className="text-bink/70 text-sm">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {otherFacilities.map((otherFacility) => (
                <Link key={otherFacility.id} href={`/facilities/${otherFacility.id}`}>
                  <Card className="hotel-card-hover overflow-hidden group cursor-pointer h-full">
                    ...
                    <CardContent className="p-6">
                      <h3 className="font-bold text-bnavy text-lg mb-2">{otherFacility.title}</h3>
                      <p className="text-bink/70 text-sm line-clamp-2">{otherFacility.shortDescription}</p>
      ...
      <section className="py-16 bg-bred text-white">
        <div className="site-container text-center">
          <h2 className="text-3xl font-black mb-4">Ready to Experience Baraka Hotel?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              size="lg"
              className="bg-white text-bred hover:bg-bpaper px-8"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white bg-transparent text-white hover:bg-white/10 hover:text-white px-8"
              asChild
            >
