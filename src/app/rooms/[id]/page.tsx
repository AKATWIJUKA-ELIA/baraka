...
export default function RoomDetailPage() {
  ...
  const roomClassification = String(params.id);
  const room = getRoomByClassification(roomClassification);
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-stone-600 text-sm">Kigali Road, Kabale</p>
                        <p className="text-stone-600 text-sm">Western Uganda</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
